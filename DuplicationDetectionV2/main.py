...
def match(file1, file2, image_type='outdoor'):
    ...
    try:
        bounding_boxes_1 = detect(source=file1, imgsz=(480, 480))
        bounding_boxes_2 = detect(source=file2, imgsz=(480, 480))
    ...
    if image_type == 'indoor':
        matcher.load_state_dict(torch.load("DuplicationDetectionV2/weights/indoor_ds.ckpt")['state_dict'])
    elif image_type == 'outdoor':
        matcher.load_state_dict(torch.load("DuplicationDetectionV2/weights/outdoor_ds.ckpt")['state_dict'])
    else:
    ...
    img0_raw = cv2.resize(img0_raw, (480, 480))
    img1_raw = cv2.resize(img1_raw, (480, 480))
...
#print(match('images\out.jpg', 'images\out1.jpg'))
...
# print('ACC:', acc/480, ' --- precision:', precision, ' --- recall:', recall, ' --- f1:', f1)